...
author: richardnye
description: "How Ansible manages a homelab web stack: deploying a .NET Core API as a systemd service, provisioning PostgreSQL, and early lessons on playbook hygiene."
---
